...
ENV PATH=$PATH:/mllib/depot_tools/
...
RUN git clone https://github.com/llvm-mirror/libcxx.git /mllib/buildtools/third_party/libc++/trunk
RUN git clone https://github.com/llvm-mirror/libcxxabi.git /mllib/buildtools/third_party/libc++abi/trunk
RUN git clone https://github.com/catapult-project/catapult.git /mllib/third_party/catapult
...
ENV DEPOT_TOOLS=/mllib/depot_tools/
